...
flags.DEFINE_string("mode", "test", "train | test | debug")
flags.DEFINE_boolean("load", True, "load saved data? [True]") # 默认加载已有model

# training / test parameters
flags.DEFINE_integer("train_batch_size", 60, "batch size []")
...
flags.DEFINE_integer("max_question_word", 100, "a question has 100 words at most")
flags.DEFINE_integer("max_passage_word", 300, "a passage has 300 words at most ")
...
flags.DEFINE_integer("eval_period", 1000)
flags.DEFINE_integer("save_period", 1000)
